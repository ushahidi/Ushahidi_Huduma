	...
	static function get_javascript()
	{
		...
		{ // Cache is Empty so Re-Cache
			...
			try {
				...
				$tag = '<!-- Piwik --><script type="text/javascript">jQuery(document).ready(function(){$(\'#piwik\').load(\'http://tracker.ushahidi.com/piwik/piwik.php?idsite='.$stat_id.'&rec=1\');});</script><div id="piwik"></div><!-- End Piwik Tag -->';
			}
