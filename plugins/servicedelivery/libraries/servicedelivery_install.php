 ...
 * @module     Service Delivery plugin installer
 * @copyright  Ushahidi - http://www.ushahidi.com
 * @license    http://www.gnu.org/copyleft/lesser.html GNU Lesser General Public License (LGPL)
 */
class Servicedelivery_Install {
    ...
    {
        if (FALSE !== $setup_sql_file = Kohana::find_file('sql', 'install_service_delivery', FALSE, 'sql'))
        {
    ...
    {
        if (FALSE !== $uninstall_sql_file = Kohana::find_file('sql', 'uninstall_service_delivery.sql', FALSE, 'sql'))
        {
            // Fetch the contents of the file
