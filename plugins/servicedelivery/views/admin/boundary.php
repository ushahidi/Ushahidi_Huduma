...
?>
            <div class="bg">
                ...
                <div class="tabs">
                    <!-- tabset -->
                    <ul class="tabset">
                        <li><a href="<?php echo url::site() ?>admin/boundaries" class="active"><?php echo Kohana::lang('ui_main.show_all'); ?></a></li>
                        <li><a href="<?php echo url::site() ?>admin/boundaries/types"><?php echo Kohana::lang('ui_servicedelivery.boundary_types');?></a></li>
                    </ul>
                    <!-- /tabset -->
