 ...
 ?>
            <div class="bg">
                ...
                <div class="tabs">
                    <!-- tabset -->
                    <ul class="tabset">
                        <li><a href="<?php echo url::site() ?>admin/dashboard/users" class="active"><?php echo Kohana::lang('ui_servicedelivery.dashboard_users');?></a></li>
                ...
                <?php if ($form_saved): ?>
            		...
            		<div class="green-box" id="submitStatus">
            			<h3><?php echo Kohana::lang('ui_servicedelivery.dashboard_user');?> <?php echo $form_action; ?>
