				...
				<?php print form::open(NULL, array('name'=>'dashoardUserForm', 'id'=>'dashboardUserForm')); ?>
                    ...
                    <div class="tabs">
                        ...
                        <ul class="tabset">
							...
							<li><a href="<?php echo url::site() ?>admin/dashboard/roles"><?php echo Kohana::lang('ui_servicedelivery.dashboard_roles');?></a></li>
                        </ul>

                        <div class="tab">
                            <ul>
                                <li><a href="#" class="btn_save"><?php echo strtoupper(Kohana::lang('ui_servicedelivery.save_user'));?></a></li>
                                <li><a href="#" class="btn_save_close"><?php echo strtoupper(Kohana::lang('ui_main.save_close'));?></a></li>
                                <?php if ($dashboard_user_id): ?>
                                    <li><a href="#" class="btn_delete btns_red"><?php echo strtoupper(Kohana::lang('ui_servicedelivery.delete_user')) ?></a></li>
                                <?php endif; ?>
                    ...
                    <?php if ($form_saved): ?>
                        <!-- green-box -->
                        <div class="green-box">
                            <h3><?php echo Kohana::lang('ui_servicedelivery.dashboard_user_saved'); ?></h3>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="report-form">
                        ...
                        <div class="sms_holder">
                            ...
                            <div class="row">
                                <h4><?php echo Kohana::lang('ui_servicedelivery.dashboard_role');?></h4>
                            ...
                            <div class="row">
                                <h4>
									...
									<?php echo Kohana::lang('ui_servicedelivery.is_active');?>
								</h4>
                            </div>
                        </div>
