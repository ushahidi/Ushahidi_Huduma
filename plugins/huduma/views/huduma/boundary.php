...
<div
	class="bg">
<h2>
	<?php huduma_tool::huduma_subtabs("admin_boundaries"); ?>
</h2>
<?php
if ($form_error) {
	?> <!-- red-box -->
...
if ($form_saved) {
	?> <!-- green-box -->
<div class="green-box">
<h3><?php echo Kohana::lang('huduma.boundary');?> <?php echo $form_action; ?></h3>
</div>
	<?php
}
?> <!-- report-table -->
<div class="report-form">
	...
	<input type="hidden" name="boundary_id" id="boundary_id_action" value="">
<div class="table-holder">
<table class="table">
	<thead>
		<tr>
			<th class="col-1"><?php echo Kohana::lang('huduma.boundary');?></th>
			<th class="col-2"><?php echo Kohana::lang('huduma.boundary_type');?></th>
			<th class="col-3"></th>
	...
	foreach ($boundaries as $boundary)
	{
		...
		<tr>
			...
			<td class="col-2"><?php echo $boundary_type_name; ?></td>
			<td class="col-3"></td>
			<td class="col-4">
			<ul>
				...
				<li><a href="javascript:userAction('d','DELETE','<?php echo(rawurlencode($boundary_id)); ?>')"
...
<!-- tab -->
<div class="tab"><?php print form::open(NULL,array('id' => 'boundaryMain', 'name' => 'boundaryMain')); ?> 
...
<div class="tab_form_item"><?php echo Kohana::lang('huduma.boundary_name');?><br />
<?php print form::input('boundary_name'); ?></div>
<div class="tab_form_item"><?php echo Kohana::lang('huduma.boundary_type');?><br />
<span class="my-sel-holder">
<?php print form::dropdown('boundary_type_id',$boundary_array,'id'); ?>
</span></div>
