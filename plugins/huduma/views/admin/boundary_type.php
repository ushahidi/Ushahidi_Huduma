            ...
            <div class="bg">
                ...
                <div class="tabs">
                    ...
                    <ul class="tabset">
                        ...
                        <li><a href="<?php echo url::site() ?>admin/servicedelivery/types" class="active"><?php echo Kohana::lang('ui_huduma.boundary_types');?></a></li>
                    </ul>
                    <!-- /tabset -->
                ...
                <div class="green-box">
                    <h3><?php echo Kohana::lang('ui_huduma.boundary_type');?> <?php echo $form_action; ?></h3>
                </div>
                <?php endif; ?>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-2"><?php echo Kohana::lang('ui_huduma.boundary_type_name');?></th>
                    ...
                    <div class="tab">
                        <?php print form::open(NULL,array('enctype' => 'multipart/form-data', 'id' => 'boundarytypeMain', 'name' => 'boundarytypeMain')); ?>
                            ...
                            <div class="tab_form_item">
                                <strong><?php echo Kohana::lang('ui_huduma.boundary_type_name');?></strong><br />
                                <?php print form::input('boundary_type_name', $form['boundary_type_name'], ' class="text"'); ?>
                            </div>
                            <div class="tab_form_item">
                                <strong><?php echo Kohana::lang('ui_huduma.parent_boundary_type');?>:</strong><br />
