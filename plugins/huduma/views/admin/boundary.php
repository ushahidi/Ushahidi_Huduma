            ...
            <div class="bg">
                ...
                <div class="tabs">
                    ...
                    <ul class="tabset">
                        ...
                        <li><a href="<?php echo url::site() ?>admin/servicedelivery/types"><?php echo Kohana::lang('ui_huduma.boundary_types');?></a></li>
                    </ul>
                    <!-- /tabset -->
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-2"><?php echo Kohana::lang('ui_huduma.boundary');?></th>
