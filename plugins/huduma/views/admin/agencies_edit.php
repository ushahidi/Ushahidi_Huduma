                ...
                <?php print form::open(NULL, array('id'=>'agencyMain', 'name'=>'agencyMain')); ?>
                    ...
                    <div class="tabs">
						...
						<ul class="tabset">
							...
							<li><a href="<?php echo url::site() ?>admin/agencies/edit" class="active"><?php echo Kohana::lang('ui_huduma.add_edit_agency');?></a></li>
                        ...
                        <div class="tab">
                            <ul>
                                <li><a href="#" class="btn_save"><?php echo strtoupper(Kohana::lang('ui_huduma.save_agency'));?></a></li>
                                <li><a href="#" class="btn_save_close"><?php echo strtoupper(Kohana::lang('ui_main.save_close'));?></a></li>
                                <?php if($agency_id): ?>
                                    <li><a href="#" class="btn_delete btns_red"><?php echo strtoupper(Kohana::lang('ui_huduma.delete_agency')) ?></a></li>
                                <?php endif; ?>
                    ...
                    <div class="report-form">
                        ...
                        <?php if ($form_saved): ?>
                            ...
                            <div class="green-box" id="submitStatus">
                                <h3><?php echo Kohana::lang('ui_huduma.agency_saved'); ?></h3>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="sms_holder">
                            <div class="row">
                                <h4><?php echo Kohana::lang('ui_huduma.agency_name'); ?></h4>
