            ...
            <div class="bg">
                ...
                <div class="tabs">
                    ...
                    <ul class="tabset">
                        ...
                        <li><a href="<?php echo url::site() ?>admin/dashboard/roles" class="active"><?php echo Kohana::lang('ui_huduma.dashboard_roles');?></a></li>
                    </ul>
                    <!-- /tabset -->

            		<div class="tab">
            			<ul>
							<li><a href="#" rel="facebox" onclick="showDashboardRoleDialog('');"><?php echo strtoupper(Kohana::lang('ui_huduma.add_role')) ;?></a></li>
                ...
                <?php if ($form_saved): ?>
            		...
            		<div class="green-box" id="submitStatus">
            			<h3><?php echo Kohana::lang('ui_huduma.dashboard_role');?> <?php echo $form_action; ?>
