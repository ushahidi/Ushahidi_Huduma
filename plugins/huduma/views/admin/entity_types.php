            ...
            <div class="bg">
                ...
                <div class="tabs">
                    ...
                    <ul class="tabset">
                        ...
                        <li><a href="<?php echo url::site() ?>admin/entities/types" class="active"><?php echo Kohana::lang('ui_huduma.entity_types');?></a></li>
                ...
                <?php if ($form_saved): ?>
            		...
            		<div class="green-box" id="submitStatus">
            			<h3><?php echo Kohana::lang('ui_huduma.entity_type');?> <?php echo $form_action; ?>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-2"><?php echo Kohana::lang('ui_huduma.entity_type_name');?></th>
				...
				<div class="tabs">
					...
					<div class="tab">
						...
						<div class="tab_form_item2">
							<strong><?php echo Kohana::lang('ui_huduma.entity_type_name');?>:</strong><br />
